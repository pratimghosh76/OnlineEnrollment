...
public class Utils {
	...
	public static WebDriver OpenBrowser(int iTestCaseRow) throws Exception{
		System.setProperty("webdriver.gecko.driver","C://ValicOnline//software//Geko17//geckodriver.exe");
		String sBrowserName;
		try{
		...
		if(sBrowserName.equals("Mozilla")){
			...
			System.out.print("new driver instantiated");
		...
		if(sBrowserName.equals("IE")){
			...
			String service = "C:\\OnlineStore\\software\\IEDriverServer.exe";
			...
			Log.info("New IEdriver instantiated");
			System.out.print("new driver instantiated");
		    driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		    Log.info("Implicit wait applied on the driver for 10 seconds");
		    driver.get(Constant.URL);
